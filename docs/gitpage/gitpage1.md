...
1. 깃허브 블로그가 될 저장소를 만든다.
    ...
    <img src="/git/gitpage1/1.png" width="100%" height="100%"/>
    

2.  repository setting 으로 이동 하면 opetions 목록이 뜬다. 밑으로 스크롤하면 , github pages 파트가 있다. 
    <img src="/git/gitpage1/2.png" width="100%" height="100%"/>

    아직 활성화가 안 되었다고 뜬다. 어떤 파일도 없기 때문이다. readme.md파일을 올려 주고 다시 온다. 

    <img src="/git/gitpage1/3.png" width="100%" height="100%"/>

    파일을 올리면 깃허브 페이지가 활성화된다. 

    <img src="/git/gitpage1/4.png" width="100%" height="100%"/>
    ...
    <img src="/git/gitpage1/5.png" width="100%" height="100%"/>
